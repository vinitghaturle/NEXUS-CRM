...
export const EditEventDialog: React.FC<EditEventDialogProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-md bg-ink/40 backdrop-blur-sm animate-fade-in text-left">
      <div className="bg-canvas border border-hairline rounded-xl shadow-product-dialog max-w-[560px] w-full max-h-[90vh] flex flex-col overflow-hidden animate-scale-up">
